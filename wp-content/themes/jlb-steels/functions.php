...
function jafar_theme_scripts() {
	...
	// Fancybox
	wp_enqueue_style( 'fancybox', 'https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.2/dist/jquery.fancybox.min.css', array(), null, 'all' );
	// Font awesome
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/fontawesome/css/all.min.css', array(), null, 'all' );
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css', array(), null, 'all' );
	wp_enqueue_style( 'animations', get_template_directory_uri() . '/css/animations.css', array(), null, 'all' );
	...
	wp_enqueue_script( 'jafar-script', get_template_directory_uri() . '/assets/js/dist/vendor.min.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'jafar-main-script', get_template_directory_uri() . '/assets/js/dist/main.min.js', array(), _S_VERSION, true );
...
// CUSTOM POST TYPES
require_once 'functions/post-types/people/cpt.people.php';
require_once 'functions/post-types/services/cpt.services.php';
require_once 'functions/post-types/case-studies/cpt.case-studies.php';
